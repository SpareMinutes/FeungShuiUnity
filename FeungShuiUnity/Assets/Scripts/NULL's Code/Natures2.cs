...
public class Natures2
{
    ...
    public List<string> personalityKeys = new List<string>{"Hardy","Lonely","Brave","Adamant"}; // just the pokemon ones for placeholders
    public Dictionary<string, List<float>> personalityDict = new Dictionary<string, List<float>>{
